...
let KorisniciService = class KorisniciService {
    constructor() {
    ...
    async blokirajOdblokirajKorisnika(id, broj) {
        let tijelo = {
            broj: broj
        };
        let parametri = { method: 'PUT', body: JSON.stringify(tijelo) };
    ...
    async prijavaKorisnika(korime, lozinka) {
        let tijelo = {
            korime: korime,
            lozinka: lozinka
        };
    ...
    async registracijaKorisnika(ime, prezime, lozinka, email, korime) {
        let tijelo = {
            ime: ime,
            prezime: prezime,
            lozinka: lozinka,
