CREATE TABLE `film` (
  ...
  `originalni_naziv` text,
  `opis` text,
  `ocjena` double DEFAULT NULL,
  `broj_glasova` int DEFAULT NULL,
  `prihodi` int DEFAULT NULL,
  `godina_izlaska` int DEFAULT NULL,
...
CREATE TABLE `korisnik` (
  ...
  `aktivacijskiKod` int DEFAULT NULL,
  `TOTPkljuc` text,
...
ALTER TABLE `watchlist`
  ADD PRIMARY KEY (`korisnik_id`,`film_id`),
  ADD KEY `fk_korisnik_has_film_film1_idx` (`film_id`),
  ADD KEY `fk_korisnik_has_film_korisnik1_idx` (`korisnik_id`);
...
--
-- Indexes for table `zanr_filma`
--
ALTER TABLE `zanr_filma`
  ADD PRIMARY KEY (`zanr_id`,`film_id`),
...
--
ALTER TABLE `watchlist`
  ADD CONSTRAINT `fk_korisnik_has_film_film1` FOREIGN KEY (`film_id`) REFERENCES `film` (`id`),
  ADD CONSTRAINT `fk_korisnik_has_film_korisnik1` FOREIGN KEY (`korisnik_id`) REFERENCES `korisnik` (`id`);

--
-- Constraints for table `zanr_filma`
--
ALTER TABLE `zanr_filma`
  ADD CONSTRAINT `fk_zanr_has_film_film1` FOREIGN KEY (`film_id`) REFERENCES `film` (`id`),
